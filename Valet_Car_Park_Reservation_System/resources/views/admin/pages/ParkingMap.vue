...
<script setup>
  ...
  //删除单元格
    ...
    const drag = (e) => {
        ...
        //         layout = this.layout.filter(obj => obj.i !== 'drop');
        //     }
    ...
    const dragend = (e) => {
        ...
        if (mouseInGrid === true) {
            ...
            GridLayout.dragEvent('dragend', 'drop', mouseXY.x, mouseXY.y, 1, 1);
            ...
            gridLayout.dragEvent('dragend', DragPos.i, DragPos.x,DragPos.y,1,1);
                try {
